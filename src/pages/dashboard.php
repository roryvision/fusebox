            ...
            <ul>
              ...
              <label for='role-visual'>Visual</label>
                <ul>
                  ...
                  <label for='role-artist'></label>Artist</li>
