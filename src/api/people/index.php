...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
  ...
  $sql = "SELECT p.profile_id, p.fname, p.lname, p.bio, pr.pronouns, m.major AS major, m2.major AS major2, r.role_name, r.role_type, p.website1, p.website2, p.instagram, p.linkedin, p.profile_pic
          FROM profile AS p
